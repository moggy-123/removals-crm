...
const enquiryToDb = e => ({
  ...
  survey_date: e.surveyDate || null, survey_time: e.surveyTime || "",
...
const enquiryFromDb = r => ({
  ...
  surveyDate: r.survey_date || "", surveyTime: r.survey_time || "",
...
const jobToDb = j => ({
  ...
  crew: j.crew || [], vehicle: j.vehicle || "", stages: j.stages || [],
...
const jobFromDb = r => ({
  ...
  crew: r.crew || [], vehicle: r.vehicle || "", stages: r.stages || [],
